...
test('calculateSurcharge: old regime', (t) => {
  t.is(calculateSurcharge('2023', 30, 'old', 75_00_000), 2_06_250);
});

test('calculateSurcharge: old regime - last slab', (t) => {
  t.is(calculateSurcharge('2023', 30, 'old', 6_00_000_00), 65_90_625);
});

test('calculateSurcharge: old regime, marginal relief', (t) => {
...
test('calculateSurcharge: new regime', (t) => {
  t.is(calculateSurcharge('2023', 30, 'new', 6_00_000_00), 44_25_000);
});

test('calculateSurcharge: new regime - last slab', (t) => {
  t.is(calculateSurcharge('2023', 30, 'new', 75_00_000), 1_95_000);
});

test('calculateSurcharge: new regime, marginal relief', (t) => {
